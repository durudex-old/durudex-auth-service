...
import (
	...
	"github.com/durudex/durudex-auth-service/internal/transport/grpc"
...
func main() {
	...
	if err != nil {
		log.Fatal().Err(err).Msg("error creating a new config")
	}
	...
	log.Info().Msg("Durudex Auth Service stopping!")
}
